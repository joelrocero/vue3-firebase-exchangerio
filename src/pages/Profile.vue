             ...
             :key="opportunity.id"
              ...
              <div class="card">
                ...
                <div v-else class="card-image">
                  <figure class="image is-4by3">
                    <img src="https://images.unsplash.com/photo-1579621970795-87facc2f976d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8bW9uZXl8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60"/>
                  </figure>
                </div>
                <div class="card-content">
                  ...
                  <div class="content">
                    ...
                    <p v-else>
                      User want to change your item for money
                    </p>
                  </div>
                </div>
